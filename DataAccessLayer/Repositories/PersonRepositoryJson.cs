...
namespace DataAccessLayer.Repositories
{
    public class PersonRepositoryJson: IRepositoryPerson
    {
        ...
        {
            string fileContent = File.ReadAllText(@"C:\Users\turgu\source\repos\TOUSollution\TuSollution\bin\Debug\net5.0-windows\Kisiler.json");
        ...
        public void SaveChanges() 
        {
            ...
            File.WriteAllText(@"C:\Users\turgu\source\repos\TOUSollution\TuSollution\bin\Debug\net5.0-windows\Kisiler.json", serializedPeople);
